...
MenuFile0:
	...
	MenuFile0Row3:
		...
		.db 0				;minimum value for option, wrap to maximum value if changed value equals this
		.db $ff				;maximum value for option, wrap to minimum value if changed value equals this
		.dw PtPlayerCurrentSamplePack				;24bit adress of option byte to change
		.db $7e
	...
	MenuFile0Row4:
		...
		.db $7e
		.db 18				;number of subroutine to execute
		.db 1				;palette number when unselected
		.db 0				;palette number when selected
	...
	MenuFile0Row5:
		...
		.db $7e
		.db 19				;number of subroutine to execute
		.db 1				;palette number when unselected
		.db 0				;palette number when selected
...
MenuFile1:
	...
	.db 0				;number of seperating rows between options
	.db 12				;number of rows/options
	.dw (MenuFile1Row0-MenuFile1)
	.dw (MenuFile1Row1-MenuFile1)
	.dw (MenuFile1Row2-MenuFile1)
	.dw (MenuFile1Row3-MenuFile1)
	.dw (MenuFile1Row4-MenuFile1)
	.dw (MenuFile1Row5-MenuFile1)
	.dw (MenuFile1Row6-MenuFile1)
	...
	MenuFile1Row0:
		...
		.db 0				;bitmask for changeable bits
		.db 0				;minimum value for option, wrap to maximum value if changed value equals this
		.db 8				;maximum value for option, wrap to minimum value if changed value equals this
		.dw SpcCurrentStreamSet				;24bit adress of option byte to change
		.db $7E
		.db 4				;number of subroutine to execute
		.db 1				;palette number when unselected
		.db 0				;palette number when selected
		.dw (MenuFile1Row0String0-MenuFile1)
		MenuFile1Row0String0:
			.db "Start stream"
			.db $00				;terminator
	...
	MenuFile1Row1:
		...
		.db 0				;minimum value for option, wrap to maximum value if changed value equals this
		.db $7f				;maximum value for option, wrap to minimum value if changed value equals this
		.dw SpcStreamVolume				;24bit adress of option byte to change
		.db $7e
		.db 0				;2 ;number of subroutine to execute
		.db 1				;palette number when unselected
		.db 0				;palette number when selected
		.dw (MenuFile1Row1String0-MenuFile1)
		MenuFile1Row1String0:
			.db "Stream volume"
			.db $00				;terminator
	...
	MenuFile1Row2:
		...
		.db 0				;bitmask for changeable bits
		.db 0				;minimum value for option, wrap to maximum value if changed value equals this
		.db 4				;maximum value for option, wrap to minimum value if changed value equals this
		.dw PtPlayerCurrentSong				;24bit adress of option byte to change
		.db $7e
	...
	MenuFile1Row3:
		...
		.dw PtPlayerCurrentSamplePack				;24bit adress of option byte to change
		.db $7e
		.db 6				;number of subroutine to execute
		.db 1				;palette number when unselected
		.db 0				;palette number when selected
		.dw (MenuFile1Row3String0-MenuFile1)
		MenuFile1Row3String0:
			.db "Upload SE-pack"
			.db $00				;terminator
	...
	MenuFile1Row4:
		...
		.dw PtPlayerCurrentSoundEffect				;24bit adress of option byte to change
		.db $7e
		.db 7				;number of subroutine to execute
		.db 1				;palette number when unselected
		.db 0				;palette number when selected
		.dw (MenuFile1Row4String0-MenuFile1)
		MenuFile1Row4String0:
			.db "Play SE"
			.db $00				;terminator
	...
	MenuFile1Row5:
		...
		.db 1				;palette number when unselected
		.db 0				;palette number when selected
		.dw (MenuFile1Row5String0-MenuFile1)
		MenuFile1Row5String0:
			.db "SE vol,pan"
			.db $00				;terminator
	...
	MenuFile1Row6:
		...
		.db 1				;palette number when unselected
		.db 0				;palette number when selected
		.dw (MenuFile1Row6String0-MenuFile1)
		MenuFile1Row6String0:
			.db "SE pitch"
			.db $00				;terminator	
