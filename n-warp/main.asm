...
.HIROM
.ROMBANKS 32           ; 2Mbits -- Tells WLA that you want to use 32 ROM banks.
.COMPUTESNESCHECKSUM
.EMPTYFILL $ff
...
.ORG    $7FC0 + HEADER_OFF
.DB     "N-Warp Daisakusen    "     ; Title (can't be more than 21 bytes, and should probably be a full 21 bytes)
...
.DB     $0b                  ; ROM Size   ( $08 = 2 Mbit, $09 = 4 Mbit, $0A = 8Mbit, $0B = 16Mbit c=32, d=64... etc )
...
CheckNextFrame:
	...
	lda.b InterruptEnableFlags	;update status of interrupt flags
	sta.l $4200
	lda.w SetIni			;set display mode
